...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(default                          ((,class (:foreground ,gray-3 :background ,gray-1))))
   ...
   `(org-document-info-keyword    ((,class (:foreground ,gray-3 :background ,yellow))))
   `(org-document-title           ((,class (:foreground ,gray-3))))
   `(org-document-info            ((,class (:foreground ,gray-3))))
   `(org-block                    ((,class (:foreground ,gray-3))))
   `(org-code                     ((,class (:foreground ,gray-3 :background ,green))))
   `(org-todo                     ((,class (:foreground ,gray-3 :background ,gray-1))))

   ;; Shell scripting
   `(sh-quoted-exec               ((,class (:foreground ,gray-3 :background ,blue))))

   ;; Status lines
   `(mode-line                    ((,class (:foreground ,gray-1 :background ,status))))
